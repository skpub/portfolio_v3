    ...
    <div class="box_container">
      ...
      <div class="box">
        ...
        <div class="content">
          ...
          `}</p>
          <p>3年次: {`
            基本情報から取って次に企業である程度経験を積んで応用情報、というレールの上を走るのはなんか癪なので、
            はじめに応用情報を取った。当時17歳。令和元年度秋試験のことである。
          ...
          <p>
            5年次: {`
            席次2位(35人中)で卒業した。なおこの時期のできる高専生は編入や研究で皆忙しくて成績に力を注げない。
            というのでこの数字にさしたる意味はない。ただ事実なので書いておいた。
            この年に CG の授業で東京タワーを作った。
      ...
      <div class="box">
        ...
        <div class="content">
          <p>3年次: {`
            ...
            ただし代償としてうつ状態が急性期に陥り、大学のリフレッシュルームで眠りながら叫び(迷惑)、
            複素解析学の知識を失い、寝込み続ける。ADHD/ASDと診断される。
          `}</p>
          <p>4年次: {`
      ...
      <div class="box">
        ...
        <div class="content">
          ...
          <ul>
            ...
            <li>M1の一学期中に修論とゼミ以外の修了に必要な単位全てを取得する。</li>
            <li>内定後バイトの予定を立てる。</li>
          </ul>
          <p>{`無事完遂。私の体力的に第一志望以外に複数社を受けることは難しかったので、せいぜいスカウトが来た企業
            (のうちただの宣伝ではなくちゃんと私のプロフィールを読んでいる企業)の面接を受けるくらいにして、
            インターンは第一志望だけ参加した。
            インターンで教わったことで印象的なのはテストの書き方。自分のコードが十分にモジュール化されていなくてテストに向いていないということが分かったので、
            Layered ArchitectureはじめinterfaceとDIによる抽象化に基づいたコードを学んで身につけるきっかけになった。
          `}</p>
        </div>
      </div>
