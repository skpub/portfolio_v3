...
<div class="box_container">
  ...
  <div class="table">
    <div class="table-row">
      <div class="table-cell"><span>Rust</span></div>
      <div class="table-cell"><span>仕様がリッチでありつつ現実的で良いと思うんだ。</span></div>
    </div>
    <div class="table-row">
...
<div class="box_container">
  ...
  <div class="table">
    <div class="table-row">
      <div class="table-cell"><span>Markdown</span></div>
      <div class="table-cell"><span>流石によく書く</span></div>
    </div>
    <div class="table-row">
      <div class="table-cell"><span>TeX</span></div>
      <div class="table-cell"><span>高専&数学科&大学院でよく書いてい(た|る)</span></div>
    </div>
  </div>
</div>
...
<div class="box_container">
  ...
  <div class="table">
    ...
    <div class="table-row">
      ...
      <div class="table-cell"><span>メインのエディタ。ただしVim拡張を入れないと使えない。</span></div>
    </div>
    <div class="table-row">
...
<div class="box_container">
  ...
  <div class="table">
    <div class="table-row">
      ...
      <div class="table-cell"><span>マイグレーションやデプロイに使う。</span></div>
    </div>
    <div class="table-row">
...
<div class="box_container">
  ...
  <div class="table">
    <div class="table-row">
      <div class="table-cell"><span>ルータ</span></div>
      <div class="table-cell"><span>{`YAMAHA RTXルータを設定できる。
        具体的には、ポートフォワーディングの設定をしたり公開サービス用にDMZを構築したり、DDNSの設定をしたり出来る。
      `}</span></div>
    </div>
    <div class="table-row">
      <div class="table-cell"><span>SSH</span></div>
      <div class="table-cell"><span>{`遠隔で自宅サーバにログインするのはもちろん、
        SSHポートフォワーディングによって外部からルータ管理画面への疎通を確立するなどの基本的な使い方が出来る。
      `}</span></div>
    </div>
  </div>
</div>
